...
elements = [  1,     2,    12,     4,    16,    17,    18,    19;
              4,    12,     3,     5,    18,    20,    21,    22;
              6,     2,    13,    14,    23,    24,    25,    26;
             14,    13,     7,     8,    25,    27,    28,    29;
              2,     6,    15,    12,    23,    30,    31,    17;
             12,    15,     9,     3,    31,    32,    33,    20;
              2,     1,    10,    13,    16,    34,    35,    24;
             13,    10,    11,     7,    35,    36,    37,    27 ];
%% 
%-------------------------------------------------------------------------%
...
figure('Name','Problem 3.1 Temperature Field','NumberTitle','off')
surf(Xq,Yq,zeros(size(Xq)),Tq)
view(2)
shading interp
a=colorbar;
title('Problem 3.1 Temperature Field')
xlabel('Position in meters')
ylabel('Position in meters')
a.Label.String = 'Temperature';

figure('Name','Problem 3.1 Heat Flux','NumberTitle','off')
quiver(x_qp,y_qp,q(1,:),q(2,:))
hold on
scatter(x_qp,y_qp)
title('Problem 3.1 Heat Flux')
xlabel('Position in meters')
ylabel('Position in meters')
hold off
